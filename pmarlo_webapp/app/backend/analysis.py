...
from .types import BuildConfig, BuildArtifact, AnalysisDebugData, _AnalysisMSMStats
...
class AnalysisMixin:
    ...
    # ... your build_analysis implementation

    def load_analysis_bundle(self, index: int) -> Optional[BuildArtifact]:

    # ... your load_analysis_bundle implementation

    def delete_analysis_bundle(self, index: int) -> bool:

    # ... your delete_analysis_bundle implementation

    @staticmethod
    def _extract_debug_data_from_build_result(...) -> Tuple[AnalysisDebugData, _AnalysisMSMStats]:

    # ... your implementation

    @staticmethod
    def _analysis_total_pairs(...) -> int:
# ... your implementation
