...
OUTPUT_ROOT = example_output_dir("02_pipeline_api")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python example_programs/02_pipeline_api.py --mode test      # Test protein preparation
  python example_programs/02_pipeline_api.py --mode simple    # Show API usage
  python example_programs/02_pipeline_api.py --mode demo      # Run simple demo
        """,
    )
