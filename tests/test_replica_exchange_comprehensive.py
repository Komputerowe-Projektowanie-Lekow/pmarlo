...
try:
    from src.pmarlo.replica_exchange.replica_exchange import ReplicaExchange, setup_bias_variables
    from src.pmarlo.protein.protein import Protein
except ImportError:
...
class TestReplicaExchangeExchangeAlgorithm:
    ...
    def mock_remd(self, test_pdb_file, temp_output_dir):
        ...
        for i, context in enumerate(remd.contexts):
            mock_state = Mock()
            mock_state.getPotentialEnergy.return_value = -1000 - i * 100  # Different energies
...
class TestReplicaExchangeIntegration:
    ...
    def test_pipeline_integration(self, test_pdb_file, temp_output_dir):
        ...
        from src.pmarlo.pipeline import Pipeline
...
class TestErrorRecovery:
    ...
    def test_minimization_failure_recovery(self, test_pdb_file, temp_output_dir):
        ...
        with patch('src.pmarlo.replica_exchange.replica_exchange.Simulation') as mock_sim_class:
            mock_sim = Mock()
