...
class TestPackageImports:
    ...
    def test_main_imports(self):
        ...
        from src import Protein, ReplicaExchange, Simulation, MarkovStateModel, Pipeline, LegacyPipeline
...
class TestWorkflowIntegration:
    ...
    def test_five_line_api_setup(self, test_pdb_file):
        ...
        replica_exchange = ReplicaExchange(str(test_pdb_file), temperatures=[300, 310, 320])
