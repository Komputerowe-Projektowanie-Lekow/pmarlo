...
from src.simulation.simulation import Simulation, prepare_system, feature_extraction
import numpy as np
...
class TestSimulation:
    ...
    @pytest.mark.skipif(True, reason="Requires OpenMM and significant computational time")
    ...
    def test_feature_extraction(self, test_trajectory_file, test_fixed_pdb_file):
        ...
        try:
            states = feature_extraction(str(test_trajectory_file), str(test_fixed_pdb_file))
...
class TestSimulationFunctions:
    ...
    def test_prepare_system_function_signature(self, test_fixed_pdb_file):
        ...
        try:
            ...
            pytest.skip("Cannot inspect function signature without required dependencies")
    ...
    def test_simulation_configuration_validation(self):
        ...
        sim = Simulation(
            ...
            temperature=300,  # Valid temperature
            steps=100
        )
